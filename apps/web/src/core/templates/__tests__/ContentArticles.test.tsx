...
const mockPage: Page = {
  ...
  technicalData: { controller: 'Cms', template: '', contentMainDocumentId: null, staticGeneratorEnabled: false, staticGeneratorLifetime: null },
  navigationData: { name: 'Articles', title: null, cssClass: null, target: null, anchor: null, parameters: null, exclude: false, relation: null, accesskey: null, tabindex: null },
  properties: [],
  editables: [],
}
